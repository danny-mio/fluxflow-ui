...
### Changed
- **Updated fluxflow-training dependency** from `>=0.3.1,<0.4.0` to `>=0.4.0,<0.5.0`
  - Aligns with fluxflow-training v0.4.0 release
  - Supports new versioning system, image contrast fixes, and multi-dataset pipelines
